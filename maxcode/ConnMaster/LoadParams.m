...
connStruct.SEE_mean = params{1,2}(24);
connStruct.SEI_mean = params{1,2}(25);
connStruct.SIE_mean = params{1,2}(26);
connStruct.SII_mean = params{1,2}(27);
connStruct.SEE_std = params{1,2}(28);
connStruct.SEI_std = params{1,2}(29);
connStruct.SIE_std = params{1,2}(30);
connStruct.SII_std = params{1,2}(31);
connStruct.Rand = params{1,2}(32);