"""
Code for generating an arbitrary neural network
Max Henderson
Drexel University
February 16, 2012
"""
...
simTime = 50
numNeurons = 1
path = '/home/hendemd/Desktop/MATLAB/bin/Neural research/Input files/'
...
#Create sinusoidal current to use on cat neuron
...
listOfTimes = []
VecSoma = h.Vector()
VecSoma.record(soma(0.5)._ref_v)
freq = 10
stimStrength = 100
