...
simTime = 50
numNeurons = 25
path = '/home/hendemd/Desktop/MATLAB/bin/Neural research/Causal nearest neighbors/'
...
#Stimulate system
stim = h.IClamp(Soma[15](0.5) )		
stim.delay = 15	
stim.dur = 15		
stim.amp = 100
stim1 = h.IClamp(Soma[5](0.5) )		
stim1.delay = 15	
stim1.dur = 15		
stim1.amp = 100
stim2 = h.IClamp(Soma[10](0.5) )		
stim2.delay = 5	
stim2.dur = 15		
stim2.amp = 100
stim3 = h.IClamp(Soma[20](0.5) )		
stim3.delay = 15	
stim3.dur = 15		
stim3.amp = 100
stim4 = h.IClamp(Soma[3](0.5) )		
stim4.delay = 5	
stim4.dur = 15		
stim4.amp = 100
stim5 = h.IClamp(Soma[8](0.5) )		
stim5.delay = 15	
stim5.dur = 15		
stim5.amp = 100
stim6 = h.IClamp(Soma[14](0.5) )		
stim6.delay = 5	
stim6.dur = 15		
stim6.amp = 100
stim7 = h.IClamp(Soma[22](0.5) )		
stim7.delay = 15	
stim7.dur = 15		
stim7.amp = 100
