...
def runSimulation(numSegs, tau, refrac, simTime, numNeurons, path, strength, dendrites, connections, conNum, numRun):
	...
	file = open(path + 'spikes' + str(conNum) + 'strength' + str(strength*1000) + 'run' + str(numRun) + '.txt',"wb")
...
refrac = 0.5
simTime = 500	
originalPath = '/home/hendemd/Desktop/MATLAB/bin/Paper 2/Testing connections 9/'
networkSize = [343]
#strengths = linspace(0.03,0.05,3)
strengths = [0, 0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.007, 0.008, 0.009, 0.01, 0.011, 0.012, 0.013, 0.014, 0.015, 0.016, 0.017, 0.018, 0.019, 0.02, 0.03, 0.04, 0.05, 0.1]
totalRuns = 2
