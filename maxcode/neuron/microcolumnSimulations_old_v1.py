...
def runSimulation(young_chem1_con1, young_elec1_con1, numNeurons, fileIndex, simTime):
	"""
...
runSimulation(old_chem1_con1,   old_elec1_con1,   numNeurons, fileIndex, simTime)
