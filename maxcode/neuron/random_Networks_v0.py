...
numNeurons = 125
numNets = 10	
#op = '/home/hendemd/Desktop/MATLAB/bin/Neural research/Random 10 by 10 Jan 8/'
op = '/home/hendemd/Desktop/MATLAB/bin/Neural research/Random 125 neurons 10 sets/'
for i in range(2, numNets+1):
	start_time = time.time()
	pos =[]
