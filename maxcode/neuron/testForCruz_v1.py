...
op = '/home/hendemd/Desktop/MATLAB/bin/Neural research/125 cruz test 2/'
start_time = time.time()
dendrites =[]
...
for j in range(1,6):
	...
	for strength in strengths:				
		runSimulation(numSegs, tau, refrac, simTime, numNeurons, currentDir, strength, dendrites, connections)
