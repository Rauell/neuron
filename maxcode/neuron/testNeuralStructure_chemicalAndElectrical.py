...
def constructConnections2( connections, dendrites, numNeurons, Soma, Axon, Dendrites, strength ):
	"""
		This definition will a connectivity matrix and make the appropriate synaptic connections.
	"""
	SYN = []
...
def runSimulation(numSegs, tau, refrac, simTime, numNeurons, path, strength1, strength2, dendrites, connections):
	"""
	...
	gaps = constructConnections1( connections, dendrites, numNeurons, Soma, Axon, Dend, strength1 )		
	synapses, networkConnections = constructConnections2( connections, dendrites, numNeurons, Soma, Axon, Dend, strength2 )
	...
	file = open(path + 'spikes' + str(1) + 'strength' + str(10) + '.txt',"wb")
	print path + 'spikes' + str(1) + 'strength' + str(strength1) + '.txt'
...
conductance = 0.1
synapseStrength = 25
op = '/home/hendemd/Desktop/MATLAB/bin/Paper 2/chemical and electrical/'
start_time = time.time()
dendrites =[]
...
runSimulation(numSegs, tau, refrac, simTime, numNeurons, op, conductance, synapseStrength, dendrites, connections)
