...
def makeStimulus( Neurons, simTime, stimInterval ):
	...
	stimNc = h.NetStim()
	stimNc.noise = 0 #1 temp for control		
	stimNc.start = 0		
...
def runSimulation_v1(young_chem1_con1, young_elec1_con1, numNeurons, fileIndex, simTime, inhibInd, age, delay, stimInterval):
	"""
...
def runSimulation_v2(young_chem1_con1, young_elec1_con1, numNeurons, fileIndex, CalculatePeriodicDistancessimTime, inhibInd, age, delay, stimInterval):
	"""
		This defintion will run the simulation.
	"""
...
if len(sys.argv) < 4:
	print "Error! Syntax is [path] [fileIndex] [stimInterval]"
	sys.exit() 
path = sys.argv[1]
...
runSimulation_v1(young_chem_con1, young_elec_con1, numNeurons, fileIndex, simTime, inhibInd, 1, youngDist, stimInterval)
#runSimulation_v1(old_chem1_age1,   old_elec1_age1, numNeurons, fileIndex, simTime, inhibInd, 2, oldDist,   stimInterval)
#runSimulation_v1(old_chem1_age2,   old_elec1_age2, numNeurons, fileIndex, simTime, inhibInd, 3, oldDist,   stimInterval)

#Run simulations with gap junctions.
runSimulation_v2(young_chem_con1, young_elec_con1, numNeurons, fileIndex, simTime, inhibInd, 1, youngDist, stimInterval)
#runSimulation_v2(old_chem1_age1,   old_elec1_age1, numNeurons, fileIndex, simTime, inhibInd, 2, oldDist,   stimInterval)
#runSimulation_v2(old_chem1_age2,   old_elec1_age2, numNeurons, fileIndex, simTime, inhibInd, 3, oldDist,   stimInterval)
